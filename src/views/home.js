    ...
    <div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          <span className="home-heading">
            <span className="home-text Card-Heading">Parham</span>
            <br></br>
          </span>
      ...
      <div className="home-container02">
        <div className="home-hero">
          <div className="home-hero-text-container">
            <h1 className="home-heading2 Section-Heading">TEEST</h1>
            <span className="home-text02">TEST</span>
      ...
      <div className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text04 Section-Heading">TEST</h2>
          <span className="home-text05">TEST</span>
        </div>
        <div className="home-cards-container">
          <div className="home-card">
            ...
            <div className="home-content-container">
              <span className="home-heading3 Card-Heading">TEST</span>
              <span className="home-text06 Card-Text">TEST</span>
            </div>
          </div>
          <div className="home-card1">
            ...
            <div className="home-content-container1">
              <span className="home-heading4 Card-Heading">TEST</span>
              <span className="home-text07 Card-Text">TEST</span>
            </div>
          </div>
          <div className="home-card2">
            ...
            <div className="home-content-container2">
              <span className="home-heading5 Card-Heading">TEST</span>
              <span className="home-text08 Card-Text">TEST</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="home-content-container3">
            <div className="home-about-1">
              <div className="home-container03">
                ...
                <span className="home-text10 Card-Text">TEST</span>
              </div>
              <div className="home-container04">
                <svg viewBox="0 0 1024 1024" className="home-icon12">
                  <path d="M170 512q0-140 101-241t241-101 241 101 101 241-101 241-241 101-241-101-101-241z"></path>
                </svg>
                <span className="home-text11 Card-Text">TEST</span>
              </div>
              <div className="home-container05">
                <svg viewBox="0 0 1024 1024" className="home-icon14">
                  <path d="M170 512q0-140 101-241t241-101 241 101 101 241-101 241-241 101-241-101-101-241z"></path>
                </svg>
                <span className="home-text12 Card-Text">TEST</span>
              </div>
            </div>
            <div className="home-about-11">
              ...
              <div className="home-container08">
                ...
                <span className="home-text17 Card-Text">TEST</span>
                <span className="home-text18 Card-Text">TEST</span>
              </div>
            </div>
          </div>
      ...
      <div className="home-subscribe">
        ...
        <div className="home-container09">
          <div className="home-heading-container2">
            <h1 className="home-text19 Section-Heading">TEST</h1>
            <span className="Section-Text home-text20">TEST</span>
          </div>
          <input
            type="text"
            required="true"
